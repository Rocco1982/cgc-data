window.CGC_DATA = {
  ...
  <div class="hero-card-media" style="background:#ffffff;">
    <img loading="lazy" decoding="async" src="https://assets.cdn.filesafe.space/FxfSu0nbVobswu1XWMTK/media/69d9272b23917331fbc8fbcc.jfif" alt="discounted Sephora gift cards">
  </div>
  <div class="hero-deal-body">
    <div class="hero-deal-price">Sephora — $0.35</div>
    <div class="hero-deal-save">Pay $0.26</div>
  ...
  marketHtml: `<article class="market-card" data-brand="Sephora" data-category="retail" data-ref="GCFC-G91752">
  <div class="market-status-row">
    <span class="market-pill market-pill-live">Live</span>
  </div>
  <div class="market-sale-badge">25.00% OFF</div>
  <div class="market-card-top" role="img" aria-label="discounted Sephora gift cards" title="discounted Sephora gift cards" style="background-image:url('https://assets.cdn.filesafe.space/FxfSu0nbVobswu1XWMTK/media/69d9272b23917331fbc8fbcc.jfif');"></div>
  <div class="market-card-body">
    <div class="market-brand">Sephora — $$0.35</div>
    <div class="market-price">$$0.26</div>
